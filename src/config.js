...
const PALLETES = [
  {
    ...
    bgColor: [218, 80, 98],
    colors: [
      { fg: [213, 72, 62], hues: [0.9, 0.8], name: 'Azure' },
      { fg: [222, 99, 54], hues: [0.9, 0.8], name: 'Indigo' },
      { fg: [279, 30, 55], hues: [0.8, 0.5], name: 'Mauve' },
      { fg: [296, 70, 66], hues: [0.8, 0.6], name: 'Magenta' },
    ],
    hasMono: true,
    probability: 0.22,
  },
  ...
  },
  {
    ...
    colors: [
      ...
      { fg: [118, 66, 26], hues: [0.8, 0.2], name: 'Emerald' },
      { fg: [213, 55, 45], hues: [0.9, 0.8], name: 'Cobalt' },
  ...
  },
  {
    ...
    colors: [
      ...
      { fg: [348, 100, 82], hues: [0.9, 0.6], name: 'Rose' },
      { fg: [350, 40, 50], hues: [0.8, 0.6], name: 'Crimson' },
    ],
    probability: 0.22,
  },

  {
    ...
    bgColor: [203, 56, 8],
    colors: [
      { fg: [172, 90, 55], name: 'Mint' },
      { fg: [186, 92, 40], name: 'Cyan' },
      { fg: [236, 100, 65], name: 'Violet' },
